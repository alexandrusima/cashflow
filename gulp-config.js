module.exports = function () {
    ...
    var config = {
        ...
        js: [
                ...
                client + 'assets/js/maps/jvectormap.min.js',
                client + 'assets/js/maps/romania.js',
                client + 'assets/js/icheck.js',
                client + 'assets/js/scroll.min.js',
                client + 'assets/js/calendar.min.js',
                client + 'assets/js/feeds.min.js',
